...
const privacyPage = hyperHTML.wire({}, 'html')`<div>
    ...
    <h6>CloudCite takes privacy very seriously. Here are some of the steps we take to protect your privacy:</h6>
    <ol>
    ...
    <ol>
        ...
        <li><b>Data Deletion:</b> CloudCite can completely delete your account, projects, and any information upon your request. To request data deletion, click on the help button on our site or email us at help@cloudcite.net.</li>
    </ol>
    <p>By using our service, you hereby consent to our <a href="/privacy/">Privacy Policy</a>, our <a href="https://github.com/Hackdromeda/cloudcite/blob/master/LICENSE" target="_blank" rel="noopener noreferrer">License</a>, our Terms of Use and agree to any applicable Terms and Conditions including those of the APIs used.</p>
</div>`;

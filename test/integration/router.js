...
describe('routing tests', function() {
  ...
  it('the page selector switches pages', async function() {
    ...
    await page.waitForSelector('cloudcite-app', {visible: true});

    await testNavigation(page, 'mainView', 'Main View');
    await testNavigation(page, 'privacy', 'Privacy Policy');
  });
  ...
  it('the page selector switches pages in a different way', async function() {
    ...
    await testNavigationInADifferentWay(page, 'privacy', 'Privacy Policy');
    await testNavigationInADifferentWay(page, 'mainView', 'Main View');
  });
});
...
async function testNavigation(page, href, linkText) {
  ...
  const myApp = await page.$('cloudcite-app');

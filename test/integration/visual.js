...
describe('👀 page screenshots are correct', function() {
  ...
  describe('wide screen', function() {
    ...
    it('/', async function() {
      return takeAndCompareScreenshot(page, 'mainView', 'wide');
    });
    it('/privacy', async function() {
      return takeAndCompareScreenshot(page, 'privacy', 'wide');
    });
  ...
  describe('narrow screen', function() {
    ...
    it('/', async function() {
      return takeAndCompareScreenshot(page, 'mainView', 'narrow');
    });
    it('/privacy', async function() {
      return takeAndCompareScreenshot(page, 'privacy', 'narrow');
    });
    it('/404', async function() {
